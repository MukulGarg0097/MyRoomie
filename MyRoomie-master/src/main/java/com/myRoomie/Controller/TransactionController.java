...
//
//@RestController
//@RequestMapping(path=PathMappings.Transaction.BASE_MAPPING)
//public class TransactionController {
//
//	@Autowired
//	ITransactionService transactionService;
//	
//	@RequestMapping(path=PathMappings.Transaction.BASE_MAPPING_ALL, method = RequestMethod.GET)
//	@ResponseBody
//	public BaseResponse<Page<RazorOrderResponse>> findAll(Pageable pageable)
//			throws BaseException{
//		Page<RazorOrderResponse> response=transactionService.findAll(pageable);
//		 return new BaseResponse<Page<RazorOrderResponse>>(false, response, ResponseCode.OK);
//	}
//	
//	@RequestMapping(path=PathMappings.ID_PARAM, method = RequestMethod.GET)
//	@ResponseBody
//	public BaseResponse<RazorOrderResponse> findById(
...
//		}
//		RazorOrderResponse response = transactionService.findById(id);
//		if(ObjectUtils.isEmpty(response)) {
//			return new BaseResponse<>(true, null, ResponseCode.INVALID_ID);
//		}
//		return new BaseResponse<RazorOrderResponse>(false, response, ResponseCode.OK);
//	}
//	
...
//	@ResponseBody
//	public BaseResponse<RazorOrderResponse> save(
//			@RequestBody(required=true) TransactionRequest request)
//			throws BaseException{
//		if(request==null)
//		{
//			return new BaseResponse<>(true, null, ResponseCode.EMPTY_REQUEST);
//		}
//		RazorOrderResponse response = transactionService.save(request);
//		if(ObjectUtils.isEmpty(response)) {
...
//	@ResponseBody
//	public BaseResponse<RazorOrderResponse> update(
//			@RequestBody(required=true) TransactionRequest request)
//			throws BaseException{
//		if(request==null)
//		{
