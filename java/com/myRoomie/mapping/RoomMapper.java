...
public class RoomMapper {
	...
	public RoomEntity mapRoomRequestToEntity(RoomRequest request)
	{
		...
		response.setCharges(request.getCharges());
		...
		response.setRoomAmenitiesMapper(request.getRoomAmenities());
		...
		response.setRoomVariants(request.getRoomVariants());
...
//		}
		...
		response.setRoomVariants(roomVariantMapper.mapRoomVariantEntityToResponse(entity.getRoomVariants()));
