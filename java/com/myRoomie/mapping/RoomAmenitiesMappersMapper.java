...
public class RoomAmenitiesMappersMapper {
	...
	@Autowired
	MasterRoomAmenitiesMapper masterAmenityMapper;
	...
	public RoomAmenitiesMapperResponse mapRoomAmenitiesToResponse(RoomAmenitiesMapper entity)
	{
		...
		if(masterAmenityrepo.existsById(entity.getMasterRoomAmenityId()))
			response.setMasterRoomAmenity(masterAmenityMapper.mapMasterRoomAmenitiesToResponse
					(masterAmenityrepo.findById(entity.getMasterRoomAmenityId()).get()));
		return response;
	}
