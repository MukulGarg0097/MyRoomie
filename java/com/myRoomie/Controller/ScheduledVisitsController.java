...
@RestController
@RequestMapping(path="/scheduledVisits")
...
//	, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE
	...
	@ResponseBody
	public BaseResponse<List<ScheduledVisitsResponse>> findAll()
			throws BaseException{
		return new BaseResponse<List<ScheduledVisitsResponse>>(false, scheduledVisitsService.findAll(), ResponseCode.OK);
	}
